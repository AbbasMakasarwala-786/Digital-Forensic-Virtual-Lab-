...
<h1><u> Determine who is logged in to the system
...
<div id="test">
    <form method="post">
        <ol>
            <li>
                <h3> Which command we use to check user logged in to the system
</h3>
                <input type="radio" name="q1" value="a"> a)psloggedon
                <br>
                <input type="radio" name="q1" value="b"> b)PsLoggedOn, rasusers
                <br>
                <input type="radio" name="q1" value="c"> c)ps
                <br>
            </li>
            <li>
                <h3>How can you determine who has recently logged onto a Linux system?
                </h3>
                <input type="radio" name="q2" value="a"> a)Use the "whoami" command
<br>
                <input type="radio" name="q2" value="b"> b)Check the "/var/log/login.log" file
                <br>
                <input type="radio" name="q2" value="c"> c)Run the "last" command<br>
            </li>
        </ol>
...
<a href="8simulation.php"><i id="next" class="fa-solid fa-circle-arrow-right fa-shake" style="color: #65011a;"></i></a>
       <?php
       }
