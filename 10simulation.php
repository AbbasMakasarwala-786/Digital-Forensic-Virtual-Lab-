...
<div id="test">
    <form method="post">
        <ol>
            <li>
                <h3>which command shows open ports
    </h3>
                <input type="radio" name="q1" value="a"> a) port
                <br>
                <input type="radio" name="q1" value="b"> b) netStat
                <br>
                <input type="radio" name="q1" value="c"> c) ports
                <br>
            </li>
        </ol>
...
<div id="result">
<a href="9simulation.php"><i id="prev"class="fa-solid fa-circle-arrow-left fa-shake" style="color: #700000;"></i></a>

<?php
if ($_SERVER['REQUEST_METHOD'] === 'POST') {

    $correct_answers = array('b');
...
<a href="grader0.php"><i id="next" class="fa-solid fa-circle-arrow-right fa-shake" style="color: #65011a;"></i></a>
       <?php
       }
