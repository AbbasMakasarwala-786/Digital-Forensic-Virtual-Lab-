...
<h1><u>List current and recent connections
...
<div id="test">
    <form method="post">
        <ol>
            <li>
                <h3> select right  commands to list current and recent connections
</h3>
                <input type="radio" name="q1" value="a"> a)nstat
                <br>
                <input type="radio" name="q1" value="b"> b)netstat
                <br>
                <input type="radio" name="q1" value="c"> c)nbstate
                <br>
            </li>
        </ol>
...
<div id="result">
<a href="7simulation.php"><i id="prev"class="fa-solid fa-circle-arrow-left fa-shake" style="color: #700000;"></i></a>
<?php
if ($_SERVER['REQUEST_METHOD'] === 'POST') {

    $correct_answers = array('a');
...
<a href="9simulation.php"><i id="next" class="fa-solid fa-circle-arrow-right fa-shake" style="color: #65011a;"></i></a>
       <?php
       }
